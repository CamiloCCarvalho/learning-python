...
DUVIDAS
    ...
    4- ARGUMENTOS DE FUNÇÕES TEM ESCOPO APENAS DENTRO DA FUNÇÃO ?
    ...
    8- NO SIGUINTE TRECHO DE CODIGO, POR QUE NÃO PODEMOS FAZER A OPERAÇÃO DENTRO DO PRINT?   
        
        lista = [1, 99, 50, 2, 1505, 27, 33, 1, 54, 99, 1]
        lista.sort()
        print(f'lista numerica ordenada:  {lista}') 
        
        SE TENTAR:
        print(lista.sort()) # retorna um None
